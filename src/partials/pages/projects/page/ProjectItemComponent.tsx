        ...
        <div>
            <div className="border border-gray-300 rounded-sm flex flex-col h-full">
                <img
                    ...
                    className="aspect-video object-cover object-center hover:cursor-pointer"
                    src={'/static/images/portofolios/' + project.thumbnail}
                    alt={project.name}
                />
                <div className="p-3 flex flex-col flex-1 justify-between">
                    ...
                    <div>
                        <div className="flex flex-wrap gap-1.5 mt-6">
                            {project.tech_stacks.map((tech_stack, i) => (
                                <StackItemComponent
