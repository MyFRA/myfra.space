...
import NavLinkComponent from './partials/NavLinkComponent'
                    ...
                    <NavLinkComponent
                        ...
                        icon={
                            <svg
                                ...
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                className="icon icon-tabler icons-tabler-outline icon-tabler-feather"
                            >
                                <path
                                    stroke="none"
                                    d="M0 0h24v24H0z"
                        ...
                        isActive={pathname.includes('/written-scenes')}
                    />
                    <NavLinkComponent
                        href="/contact"
                        title="Contact"
